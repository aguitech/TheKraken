...
public class ProductosAdapter extends BaseAdapter {
    ...
    ArrayList<String> _listaCantidad;
    ArrayList<String> _listaProducto;
    ArrayList<String> _listaCostoUnitario;
    ArrayList<String> _listaCostoTotal;
    ArrayList<String> _listaIdProducto;
    ...
    public ProductosAdapter(int valueID, Detalle_contrato mainActivity, ArrayList<String> listaCantidad, ArrayList<String> listaProducto, ArrayList<String> listaCostoUnitario, ArrayList<String> listaCostoTotal, ArrayList<String> listaIdProducto){
        _listaCantidad = listaCantidad;
        _listaProducto = listaProducto;
        _listaCostoUnitario = listaCostoUnitario;
        _listaCostoTotal = listaCostoTotal;
        _listaIdProducto = listaIdProducto;
    ...
    public class Holder{
        TextView cantidad;
        TextView concepto;
        TextView costo_unitario;
        TextView costo_total;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final View rowView;
        rowView = inflater.inflate(R.layout.list_productos, null);
        final int pos = i;

        holder.cantidad = (TextView) rowView.findViewById(R.id.txtCantidad);
        holder.concepto = (TextView) rowView.findViewById(R.id.txtConcepto);
        holder.costo_unitario = (TextView) rowView.findViewById(R.id.txtCostoUnitario);
        holder.costo_total = (TextView) rowView.findViewById(R.id.txtCostoTotal);


        holder.cantidad.setText(_listaCantidad.get(i));
        holder.concepto.setText(_listaProducto.get(i));
        holder.costo_unitario.setText(_listaCostoUnitario.get(i));
        holder.costo_total.setText(_listaCostoTotal.get(i));
